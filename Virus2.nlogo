...
globals
  [ %infected            ;; what % of the population is infectious
    ...
    average-age          ;; average-age of turtles in years
]
...
to setup-constants
  set lifespan 100 * 52      ;; 100 times 52 weeks = 100 years = 5200 weeks old
...
to-report infection-probability
  ...
  [report infectiousness]  ;;у дорослих сильніший імунітет
  if age > 52 * 50
